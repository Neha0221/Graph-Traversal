public class BFSPathfinding extends Strategy {

    public BFSPathfinding(int size) {
        super(size);
    }

    public BFSPathfinding(Frame frame, int size) {
        super(frame, size);
    }

    public BFSPathfinding(Frame frame, int size, Node start, Node end) {
