...
public class ControlHandler {
	...
	public ControlHandler(Frame frame, String algo[]) {
		this.frame = frame;
		this.algo = algo;
	...
	public void position() {
		...
		// Set ComboBox bounds
		comboBox.setBounds(320, frame.getHeight() - 92, 80, 20);
	}
	...
	public void hoverColour() {
		...
		comboBox.setForeground(style.lightText);
	}
	...
	public void nonHoverColour() {
		...
		comboBox.setForeground(style.darkText);
	}
